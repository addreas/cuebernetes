...
k: CustomResourceDefinition: "alerts.notification.toolkit.fluxcd.io": {
...
k: CustomResourceDefinition: "buckets.source.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
...
k: CustomResourceDefinition: "gitrepositories.source.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
...
k: CustomResourceDefinition: "helmcharts.source.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
...
k: CustomResourceDefinition: "helmreleases.helm.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					apiVersion: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxdescription)
						let _cue_xxxxxxxxdescription = {
							"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
						}
						type: "string"
					}
					kind: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxdescription)
						let _cue_xxxxxxxxxdescription = {
							"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
						}
						type: "string"
					}
...
k: CustomResourceDefinition: "helmrepositories.source.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					apiVersion: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxdescription = {
							"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
						}
						type: "string"
					}
					kind: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxdescription = {
							"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
						}
						type: "string"
					}
...
k: CustomResourceDefinition: "kustomizations.kustomize.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					apiVersion: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxdescription = {
							"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
						}
						type: "string"
					}
					kind: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxxdescription = {
							"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
						}
						type: "string"
					}
...
k: CustomResourceDefinition: "providers.notification.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					apiVersion: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxxxdescription = {
							"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
						}
						type: "string"
					}
					kind: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxxxxdescription = {
							"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
						}
						type: "string"
					}
...
k: CustomResourceDefinition: "receivers.notification.toolkit.fluxcd.io": {
	apiVersion: "apiextensions.k8s.io/v1"
	kind:       "CustomResourceDefinition"
	metadata: {
		annotations: "controller-gen.kubebuilder.io/version": "v0.3.0"
	...
	spec: {
		...
		versions: [{
			...
			schema: openAPIV3Schema: {
				...
				properties: {
					apiVersion: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxxxxxdescription = {
							"APIVersion defines the versioned schema of this representation of an object. Servers should convert recognized schemas to the latest internal value, and may reject unrecognized values. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources"
						}
						type: "string"
					}
					kind: {
						description: yaml656e63.Marshal(_cue_xxxxxxxxxxxxxxxxxdescription)
						let _cue_xxxxxxxxxxxxxxxxxdescription = {
							"Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info": "https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds"
						}
						type: "string"
					}
...
k: ServiceAccount: "helm-controller": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
k: ServiceAccount: "kustomize-controller": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
k: ServiceAccount: "notification-controller": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
k: ServiceAccount: "source-controller": {
	apiVersion: "v1"
	kind:       "ServiceAccount"
	metadata: {
		labels: {
...
k: ClusterRole: "crd-controller-flux-system": {
...
k: ClusterRoleBinding: "cluster-reconciler-flux-system": {
	apiVersion: "rbac.authorization.k8s.io/v1"
...
k: ClusterRoleBinding: "crd-controller-flux-system": {
	apiVersion: "rbac.authorization.k8s.io/v1"
	kind:       "ClusterRoleBinding"
	metadata: {
		labels: {
...
k: Service: "notification-controller": {
	apiVersion: "v1"
	kind:       "Service"
	metadata: {
		labels: {
...
k: Deployment: "helm-controller": {
	...
	spec: {
		replicas: 1
		selector: matchLabels: app: "helm-controller"
		template: {
			metadata: {
				annotations: {
...
k: Deployment: "kustomize-controller": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
k: Deployment: "notification-controller": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
	...
	spec: {
		replicas: 1
		selector: matchLabels: app: "notification-controller"
		template: {
			metadata: {
				annotations: {
					"prometheus.io/port":   "8080"
			...
			spec: {
				containers: [{
					...
					image:           "ghcr.io/fluxcd/notification-controller:v0.8.0"
					imagePullPolicy: "IfNotPresent"
					livenessProbe: httpGet: {
						path: "/healthz"
						port: "healthz"
...
k: Deployment: "source-controller": {
	apiVersion: "apps/v1"
	kind:       "Deployment"
	metadata: {
		labels: {
...
k: NetworkPolicy: "allow-scraping": {
...
k: NetworkPolicy: "allow-webhooks": {
	apiVersion: "networking.k8s.io/v1"
	kind:       "NetworkPolicy"
	metadata: {
		labels: {
