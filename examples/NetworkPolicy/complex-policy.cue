...
k: NetworkPolicy: "network-policy-policy": {
	spec: {
		...
		policyTypes:
		// This field is inferred from existence of rules further below. All policies are assumed to affect ingress. Hence "Egress" here if you want an egress-only policy.
		[
			"Ingress",
			"Egress",
		]
